...
The first inventory pass treats every observed code as a code-level observation, not as a final graphemic unit. This distinction is necessary because the local corpus contains 713 observed non-zero codes, while ICIT documentation describes the Wells list as a 676-sign sign list \citep{fulsICIT}. The discrepancy does not by itself prove that the local corpus has extra signs; it tells us that a crosswalk and variant audit must precede any claim about the functional size of the script.
...
\midrule
Rows & 5,679 \\
Non-zero sign tokens & 18,061 \\
Unique non-zero codes & 713 \\
Eroded \texttt{000} tokens & 1,881 \\
Dominant non-zero codes, $\geq 500$ tokens & 6 \\
Hapax codes & 218 \\
...
The frequency profile is highly compressed. Six dominant non-zero codes account for 4,970 tokens; 43 codes with at least 100 occurrences account for 12,151 tokens. Conversely, 448 codes occur five times or fewer. These rare codes are the first candidates for allograph checks, damaged readings, narrow regional variants, and possible cataloging noise.
...
\bottomrule
\end{tabular}
\caption{Frequency bands for non-zero sign codes.}
...
\midrule
0.50 & 22 & 9,240 & 18,061 \\
0.75 & 61 & 13,558 & 18,061 \\
0.90 & 159 & 16,265 & 18,061 \\
0.95 & 265 & 17,162 & 18,061 \\
0.99 & 533 & 17,881 & 18,061 \\
\bottomrule
\end{tabular}
\caption{Number of most frequent codes needed to cover the non-zero token stream.}
