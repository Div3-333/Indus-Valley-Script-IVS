...
Rows analyzed: 3,152. Unique analyzable sign codes analyzed positionally: 605.
...
The next analytical milestone is sign-inventory compression. We must separate primary signs, allographs, stroke/numeral candidates, damaged signs, encoded spaces, and local sign-list conventions before treating the 712 observed analyzable codes as linguistic units.
