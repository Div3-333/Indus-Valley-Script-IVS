...
Local Fuls 2023 SearchInside PDF sample & Partial ICIT visual mapping & Active local evidence; not committed & Searchable 35-page sample with embedded sign-list images. It includes visual evidence for ICIT signs \texttt{820} and \texttt{920}, but not a complete visual table for the current Tier 1 target set. \\
