...
Fuls 2013 positional analysis & Tracked local PDF & Supplies the page 10 \texttt{692} panel and positional-method argument. \\
...
Marshall 1931 Mohenjo-daro Vol. II & Tracked local PDF & Archaeological context and early excavation reference. \\
...
The local Fuls 2022 corpus sample is a major upgrade for visual review. PDF page 21 lists 205 high-number ICIT signs and contains 205 embedded sign images; layout-ordered extraction gives direct catalog visuals for \texttt{705}, \texttt{706}, \texttt{817}, \texttt{820}, \texttt{861}, and \texttt{920}. The Fuls 2013 positional-analysis article supplies the missing \texttt{692} panel on PDF page 10. This gives both visual sides for all four Tier 1 pairs. These are visual-review inputs only; no merge or variant claim is licensed until artifact-level checks are complete.
...
\midrule
\texttt{692} & 10 & \texttt{692}/\texttt{920} & Pair-side visual evidence \\
...
\texttt{920} & 21 & \texttt{692}/\texttt{920} & Pair-side visual evidence \\
\bottomrule
\end{tabular}
...
The first review pack identifies \texttt{817}/\texttt{861}, \texttt{817}/\texttt{820}, \texttt{705}/\texttt{706}, and \texttt{692}/\texttt{920} as the strongest immediate candidates for visual/catalog inspection. The local PDF library now supplies both visual sides for all four pairs. No sign merge is proposed at this stage.
